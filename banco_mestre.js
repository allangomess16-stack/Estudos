...
// BLOCO: PORTUGUÊS AVANÇADO (NÍVEL CONCURSO CÂMARA)

    { 
        id: 1001, s: 'p', p: 2, 
        q: "No que se refere à concordância verbal, assinale a opção em que a norma-padrão é respeitada, considerando a presença de sujeitos compostos ou expressões partitivas:", 
        o: ["A maior parte dos parlamentares, durante a sessão acalorada de ontem, retiraram-se antes da votação final.", "Não só o diretor da TV, mas também o coordenador de caracteres, assinou o novo protocolo de transmissão.", "Faltam, ao técnico de vídeo e ao operador de GC, a devida capacitação para operar o novo switcher NDI.", "Mais de um vereador se agrediram verbalmente durante o debate sobre a emenda à Lei Orgânica."], 
        a: 0, 
        e: "Com expressões partitivas (a maior parte de, a maioria de), o verbo pode concordar com o núcleo ou com o especificador no plural. A opção B exige plural por causa de 'não só... mas também'. A opção C exige plural (Faltam... a capacitação e o zelo). A D exige plural apenas se houver reciprocidade clara, mas 'retiraram-se' é a aplicação clássica da regra partitiva." 
    },
    { 
        id: 1002, s: 'p', p: 2, 
        q: "Assinale a alternativa em que o sinal indicativo de crase foi empregado em estrita observância à regência nominal ou verbal:", 
        o: ["O sinal de vídeo foi enviado àquele monitor que apresentava instabilidade de Genlock.", "A equipe técnica informou que o acesso à rede interna ocorrerá à partir das oito horas.", "As transmissões solenes da Câmara de Goiânia acontecem de segunda à sexta, sem atrasos.", "O coordenador de caracteres referiu-se à uma servidora que acabara de ser empossada."], 
        a: 0, 
        e: "O verbo 'referir-se' exige preposição 'a'. O pronome 'àquele' (a + aquele) recebe a crase. Em B, 'partir' é verbo (proibido). Em C, 'de... a' não tem crase. Em D, não há crase antes de artigo indefinido (uma)." 
    },
    { 
        id: 1003, s: 'p', p: 2, 
        q: "Identifique o erro de sintaxe na colocação pronominal presente nas frases abaixo, considerando a norma culta para textos oficiais:", 
        o: ["Tudo se resolveu quando o sinal SDI foi reestabelecido no rack principal.", "Nunca comunicaram-me sobre a alteração na escala de plantão do final de semana.", "O diretor nos informou que os novos geradores de caracteres chegarão em breve.", "Quem te avisou que a sessão extraordinária havia sido convocada pelo Prefeito?"], 
        a: 1, 
        e: "Palavras negativas (Nunca, Não, Jamais) são atrativas e exigem PRÓCLISE. O correto seria: 'Nunca me comunicaram'." 
    },
    { 
        id: 1004, s: 'p', p: 2, 
        q: "Analise a frase: 'O técnico de áudio, conquanto fosse experiente, não detectou o ruído de fase no sinal'. A conjunção em destaque estabelece valor semântico de:", 
        o: ["Causa, podendo ser substituída por 'visto que' sem alteração de sentido.", "Condição, indicando que a experiência era requisito para a detecção.", "Concessão, introduzindo uma oposição que não anula o fato principal.", "Consequência, demonstrando o resultado direto da experiência do técnico."], 
        a: 2, 
        e: "'Conquanto' é conjunção concessiva (embora, ainda que). Indica que, apesar de ser experiente, ele falhou." 
    },
    { 
        id: 1005, s: 'p', p: 2, 
        q: "No trecho 'Tratam-se de mudanças regimentais urgentes', a frase apresenta um desvio de concordância porque:", 
        o: ["O sujeito é 'mudanças regimentais', logo o verbo deveria estar no plural.", "A partícula 'se' é índice de indeterminação do sujeito, exigindo o verbo no singular.", "O verbo 'tratar' é transitivo direto e deveria concordar com o objeto.", "A preposição 'de' obriga o verbo a concordar com o núcleo do adjunto adverbial."], 
        a: 1, 
        e: "Em 'tratar-se de', o 'se' é índice de indeterminação do sujeito. Verbo transitivo indireto + SE exige terceira pessoa do SINGULAR: 'Trata-se de mudanças'." 
    },
    { 
        id: 1006, s: 'p', p: 2, 
        q: "Assinale a opção em que a substituição do verbo HAVER pelo EXISTIR foi feita respeitando-se as regras de concordância verbal:", 
        o: ["Havia problemas no sinal / Existia problemas no sinal.", "Hão de haver soluções / Hão de existirem soluções.", "Pode haver falhas técnicas / Podem existir falhas técnicas.", "Haveria muitos inscritos / Existiria muitos inscritos."], 
        a: 2, 
        e: "'Haver' (existir) é impessoal. 'Existir' é um verbo comum; ele deve concordar com o sujeito (falhas técnicas). Logo: 'Podem existir falhas'." 
    },
    { 
        id: 1007, s: 'p', p: 2, 
        q: "Na oração 'Goiânia, 24 de outubro de 1933', o uso da vírgula justifica-se por:", 
        o: ["Isolar o vocativo usado para chamar a atenção da cidade.", "Separar o adjunto adverbial de lugar deslocado.", "Indicar a elipse do verbo 'acontecer'.", "Separar elementos de uma enumeração de datas."], 
        a: 1, 
        e: "A vírgula separa a localidade do restante da data, funcionando como um adjunto adverbial de lugar." 
    },
    { 
        id: 1008, s: 'p', p: 2, 
        q: "Sobre a pontuação, assinale a alternativa em que a retirada das vírgulas altera o sentido da oração, transformando uma explicação em uma restrição:", 
        o: ["O operador de GC, Allan Silva, revisou todo o banco de dados mestre.", "Os técnicos de vídeo, que estudam o Regimento Interno, passarão na prova.", "A cidade de Goiânia, capital de Goiás, possui um belo acervo Art Déco.", "A Lei Orgânica do Município, que é a lei maior, deve ser respeitada por todos."], 
        a: 1, 
        e: "Com vírgulas, dizemos que TODOS os técnicos estudam e passarão (explicativa). Sem vírgulas, apenas os técnicos que estudam (não todos) passarão (restritiva)." 
    },
    { 
        id: 1009, s: 'p', p: 2, 
        q: "Assinale a alternativa que apresenta a regência verbal correta de acordo com a norma culta:", 
        o: ["O projeto de lei visa o bem-estar da população goianiense.", "Todos os servidores aspiram ao cargo de técnico legislativo.", "O Presidente da Câmara procedeu a leitura da ata da sessão anterior.", "O operador assistiu o novo tutorial de operação do switcher."], 
        a: 1, 
        e: "'Aspirar' no sentido de desejar exige preposição 'A'. Em A, 'Visar' exige 'ao'. Em C, 'Proceder' exige 'à'. Em D, 'Assistir' exige 'ao'." 
    },
    { 
        id: 1010, s: 'p', p: 2, 
        q: "Qual a função sintática do termo em destaque em: 'A aprovação **do projeto** foi comemorada pelos vereadores'?", 
        o: ["Objeto Indireto, por estar ligado a um verbo com preposição.", "Adjunto Adnominal, por indicar posse ou característica do substantivo.", "Complemento Nominal, pois sofre a ação de aprovar contida no substantivo.", "Agente da Passiva, por realizar a ação de ser aprovado."], 
        a: 2, 
        e: "'Aprovação' é substantivo abstrato derivado de verbo. O projeto FOI aprovado (paciente), logo é Complemento Nominal." 
    },
    { 
        id: 1011, s: 'p', p: 2, 
        q: "Assinale o período em que há uma oração subordinada substantiva objetiva direta:", 
        o: ["É necessário que todos os operadores estudem o Regimento.", "O técnico garantiu que o sinal de vídeo não cairá durante a live.", "Tenho esperança de que a nomeação ocorra ainda este semestre.", "A verdade é que o sistema de áudio precisa de manutenção urgente."], 
        a: 1, 
        e: "Quem garante, garante algo. 'Que o sinal não cairá' completa o verbo garantir sem preposição obrigatória (ISSO)." 
    },
    { 
        id: 1012, s: 'p', p: 2, 
        q: "Quanto ao uso dos pronomes relativos, assinale a opção correta:", 
        o: ["Esta é a câmera onde os técnicos realizaram os ajustes de foco.", "O projeto de lei cujas as emendas foram rejeitadas voltará à pauta.", "Refiro-me ao parlamentar de que o senhor mencionou no discurso.", "Este é o software de GC com que o operador trabalha diariamente."], 
        a: 3, 
        e: "'Trabalhar' exige preposição 'com'. O relativo 'que' deve vir acompanhado dela. Em A, 'onde' só para lugares físicos. Em B, proibido usar artigo após 'cujas'." 
    },
    { 
        id: 1013, s: 'p', p: 2, 
        q: "Indique a alternativa que apresenta uma figura de linguagem denominada METONÍMIA:", 
        o: ["A TV Câmara é um farol que ilumina as decisões da capital.", "O plenário inteiro aplaudiu a decisão do Presidente da Casa.", "Sua voz é doce como o mel ao proferir o voto de desempate.", "O vereador faltou com a verdade durante seu depoimento na CPI."], 
        a: 1, 
        e: "'O plenário' (lugar) é usado para representar 'os vereadores' (pessoas). Substituição do continente pelo conteúdo." 
    },
    { 
        id: 1014, s: 'p', p: 2, 
        q: "Assinale a alternativa grafada inteiramente de acordo com o Novo Acordo Ortográfico:", 
        o: ["O micro-ondas da copa da Câmara apresentou um super-aquecimento.", "A assembléia decidiu manter o auto-atendimento no balcão de serviços.", "O projeto inter-relaciona a infra-estrutura urbana com o meio ambiente.", "O ex-diretor solicitou a re-edição dos caracteres da sessão solene."], 
        a: 2, 
        e: "Prefixos terminados em consoante igual à que inicia a palavra pedem hífen (inter-relaciona). 'Infraestrutura' não tem hífen (letras diferentes se unem)." 
    },
    { 
        id: 1015, s: 'p', p: 2, 
        q: "O antônimo de 'efêmero' e o sinônimo de 'perene' são, respectivamente:", 
        o: ["Passageiro e duradouro.", "Eterno e passageiro.", "Duradouro e eterno.", "Rápido e constante."], 
        a: 2, 
        e: "Efêmero é passageiro, logo o antônimo é duradouro. Perene é algo que dura sempre, logo é eterno." 
    },
    { 
        id: 1016, s: 'p', p: 2, 
        q: "Assinale a opção em que o pronome oblíquo 'LHE' é utilizado corretamente como objeto indireto:", 
        o: ["O técnico de vídeo viu-lhe operando o switcher ontem.", "O coordenador informou-lhe que a escala havia mudado.", "Eu encontrei-lhe no corredor da Câmara Municipal.", "O sinal caiu e eu ajudei-lhe a reestabelecer a conexão."], 
        a: 1, 
        e: "'Lhe' substitui 'a ele/a ela'. Quem informa, informa algo A alguém. Verbos como 'ver', 'encontrar' e 'ajudar' (neste contexto) pedem 'o/a'." 
    },
    { 
        id: 1017, s: 'p', p: 2, 
        q: "Escolha a grafia correta para completar a lacuna: 'O vereador inter____ na discussão para evitar um impasse'.", 
        o: ["veio", "viu", "vencionou", "vinha"], 
        a: 0, 
        e: "O verbo intervir deriva de 'vir'. Se ele VEIO, ele INTERVEIO." 
    },
    { 
        id: 1018, s: 'p', p: 2, 
        q: "Qual das opções abaixo apresenta uma oração sem sujeito?", 
        o: ["Faziam-se planos para a nova transmissão digital.", "Devem existir novas regras para o uso do plenário.", "Havia muitos interessados no concurso da Câmara.", "Anunciaram a data oficial da prova hoje cedo."], 
        a: 2, 
        e: "Verbo HAVER no sentido de EXISTIR é impessoal e não possui sujeito." 
    },
    { 
        id: 1019, s: 'p', p: 2, 
        q: "Assinale a alternativa em que a partícula 'QUE' funciona como um pronome relativo:", 
        o: ["É necessário que estudemos o regimento todos os dias.", "O técnico garantiu que o sinal de áudio estava balanceado.", "O software de GC que utilizamos na TV Câmara é muito estável.", "Que alegria ver o resultado da prova hoje!"], 
        a: 2, 
        e: "Pode ser substituído por 'O QUAL'. 'O software o qual utilizamos'." 
    },
    { 
        id: 1020, s: 'p', p: 2, 
        q: "O termo 'Inexorável' no contexto jurídico-administrativo significa algo que:", 
        o: ["Pode ser perdoado ou relevado pela autoridade superior.", "Não se deixa mover por rogos ou súplicas; implacável.", "Possui validade temporária e depende de sanção do prefeito.", "Refere-se a atos administrativos que podem ser anulados."], 
        a: 1, 
        e: "Inexorável é o que não cede, o que é rígido e implacável." 
    },
    ...
    {
        id: 3010, s: 'l', p: 2, tema: "ALEGO - Raciocínio Lógico",
    ...
    {
        id: 3011, s: 'l', p: 2, tema: "ALEGO - Raciocínio Lógico",
...
// BLOCO: RACIOCÍNIO LÓGICO AVANÇADO (NÍVEL CONCURSO CÂMARA)

    { 
        id: 2001, s: 'l', p: 1, 
        q: "Considere a proposição composta: 'Se o operador de GC comete um erro de digitação, então a tarja deve ser removida imediatamente'. De acordo com a lógica sentencial, uma proposição logicamente equivalente a esta é:", 
        o: ["Se a tarja foi removida imediatamente, então o operador de GC cometeu um erro de digitação.", "O operador de GC comete um erro de digitação e a tarja não é removida.", "O operador de GC não comete um erro de digitação ou a tarja é removida imediatamente.", "Se o operador de GC não comete um erro de digitação, então a tarja não deve ser removida."], 
        a: 2, 
        e: "Equivalência da Condicional (P -> Q): Uma das regras é (~P v Q). Nega-se a primeira parte OU mantém-se a segunda conforme a regra da disjunção inclusiva." 
    },
    { 
        id: 2002, s: 'l', p: 1, 
        q: "Qual é a negação lógica da afirmação: 'Allan é técnico de vídeo e Roberta é coordenadora de caracteres'?", 
        o: ["Allan não é técnico de vídeo e Roberta não é coordenadora de caracteres.", "Allan não é técnico de vídeo ou Roberta não é coordenadora de caracteres.", "Se Allan não é técnico de vídeo, então Roberta não é coordenadora.", "Allan é técnico de vídeo ou Roberta é coordenadora."], 
        a: 1, 
        e: "Lei de De Morgan: Para negar o conectivo 'E' (^), negamos ambas as proposições e trocamos o conectivo por 'OU' (v)." 
    },
    { 
        id: 2003, s: 'l', p: 1, 
        q: "Dizer que 'Não é verdade que, se o sinal SDI cair, a transmissão será interrompida' é logicamente equivalente a dizer que:", 
        o: ["O sinal SDI caiu e a transmissão não foi interrompida.", "Se o sinal SDI não cair, a transmissão não será interrompida.", "O sinal SDI não caiu ou a transmissão foi interrompida.", "Se a transmissão for interrompida, então o sinal SDI caiu."], 
        a: 0, 
        e: "Negação da Condicional (P -> Q): Regra do 'MANÉ' (MAntém a primeira E NEga a segunda). P ^ ~Q." 
    },
    { 
        id: 2004, s: 'l', p: 1, 
        q: "Considere a seguinte sentença: 'Ou o switcher está configurado em 1080p ou a imagem apresentará serrilhados'. Do ponto de vista da lógica, se a imagem não apresenta serrilhados, pode-se concluir que:", 
        o: ["O switcher não está configurado em 1080p.", "O switcher está configurado em 1080p.", "A configuração do switcher é irrelevante para o erro de serrilhado.", "O switcher está desligado."], 
        a: 1, 
        e: "Disjunção Exclusiva (Ou P, ou Q): Em uma disjunção exclusiva, apenas uma das partes pode ser verdadeira. Se Q é falso (não há serrilhados), P deve ser obrigatoriamente verdadeiro." 
    },
    { 
        id: 2005, s: 'l', p: 1, 
        q: "A negação da proposição 'Todo técnico da Câmara Municipal de Goiânia possui certificação em NDI' é:", 
        o: ["Nenhum técnico da Câmara possui certificação em NDI.", "Todos os técnicos da Câmara não possuem certificação em NDI.", "Pelo menos um técnico da Câmara não possui certificação em NDI.", "Alguns técnicos da Câmara possuem certificação em NDI."], 
        a: 2, 
        e: "Negação de Proposições Quantificadas: Para negar o 'Todo', usamos o 'Pelo menos um não' (ou Algum não / Existe um que não)." 
    },
    { 
        id: 2006, s: 'l', p: 1, 
        q: "Se as proposições P e Q são falsas, qual das seguintes proposições compostas resulta em um valor lógico VERDADEIRO?", 
        o: ["P ^ Q", "P v Q", "P -> Q", "~(~P)"], 
        a: 2, 
        e: "Na condicional (P -> Q), se o antecedente (P) é falso, o resultado é sempre verdadeiro, independente do valor de Q (Regra da Vera Fischer: só dá falso se for V -> F)." 
    },
    { 
        id: 2007, s: 'l', p: 1, 
        q: "Uma sentença logicamente equivalente a 'Se estudo para o concurso da Câmara, então terei sucesso profissional' é:", 
        o: ["Se não terei sucesso profissional, então não estudo para o concurso da Câmara.", "Se terei sucesso profissional, então estudo para o concurso da Câmara.", "Estudo para o concurso da Câmara e não terei sucesso profissional.", "Ou estudo para o concurso da Câmara ou terei sucesso profissional."], 
        a: 0, 
        e: "Equivalência pela Contrapositiva: Inverte a ordem das proposições e nega ambas: (P -> Q) <=> (~Q -> ~P)." 
    },
    { 
        id: 2008, s: 'l', p: 1, 
        q: "Qual a negação de 'Algum vereador de Goiânia é contra o projeto de lei'?", 
        o: ["Pelo menos um vereador é a favor do projeto.", "Nenhum vereador de Goiânia é contra o projeto de lei.", "Todos os vereadores são contra o projeto de lei.", "Alguns vereadores não são contra o projeto de lei."], 
        a: 1, 
        e: "Para negar o 'Algum', usamos o 'Nenhum'. A negação da existência de uma característica em parte do grupo é a afirmação de que ninguém no grupo a possui." 
    },
    { 
        id: 2009, s: 'l', p: 1, 
        q: "Considere as premissas: 'Todos os operadores de caracteres são detalhistas' e 'Allan é operador de caracteres'. A conclusão logicamente válida para este argumento é:", 
        o: ["Allan não é detalhista.", "Alguns operadores de caracteres não são detalhistas.", "Allan é detalhista.", "Quem é detalhista é operador de caracteres."], 
        a: 2, 
        e: "Silogismo Categórico: Se um indivíduo pertence a um conjunto onde todos os membros possuem uma característica, esse indivíduo obrigatoriamente possui tal característica." 
    },
    { 
        id: 2010, s: 'l', p: 1, 
        q: "Na tabela-verdade do conectivo Bicondicional (P <-> Q), o resultado é VERDADEIRO quando:", 
        o: ["P e Q possuem valores lógicos diferentes.", "P é verdadeiro e Q é falso.", "P e Q possuem o mesmo valor lógico (ambos V ou ambos F).", "P é falso, independente do valor de Q."], 
        a: 2, 
        e: "A Bicondicional exige igualdade para ser verdade. É o conectivo da equivalência mútua." 
    },
    { 
        id: 2011, s: 'l', p: 1, 
        q: "Se 'O backup é realizado' é uma proposição verdadeira e 'O servidor está cheio' é uma proposição falsa, a conjunção destas duas sentenças resulta em:", 
        o: ["Verdadeiro.", "Falso.", "Inconclusivo.", "Tautológico."], 
        a: 1, 
        e: "Na conjunção (E), o resultado só é verdadeiro se AMBAS as partes forem verdadeiras. (V ^ F = F)." 
    },
    { 
        id: 2012, s: 'l', p: 1, 
        q: "A negação lógica de 'P v ~Q' (P ou não Q) é:", 
        o: ["~P ^ Q", "~P v Q", "P ^ Q", "~P ^ ~Q"], 
        a: 0, 
        e: "Lei de De Morgan: Nega a primeira (~P), troca o 'OU' pelo 'E' (^), e nega a segunda (~(~Q) vira Q). Resultado: ~P ^ Q." 
    },
    { 
        id: 2013, s: 'l', p: 1, 
        q: "Identifique a sentença que representa uma TAUTOLOGIA:", 
        o: ["O sinal SDI caiu e o sinal SDI não caiu.", "Se o sinal SDI caiu, então o sinal SDI caiu.", "O sinal SDI caiu ou a transmissão parou.", "Se o sinal SDI caiu, então a transmissão parou."], 
        a: 1, 
        e: "Tautologia é uma proposição que é sempre verdadeira. 'P -> P' ou 'P v ~P' são formas básicas de tautologia." 
    },
    { 
        id: 2014, s: 'l', p: 1, 
        q: "O argumento 'Se corro, me canso. Não estou cansado. Logo, não corri' é um exemplo de:", 
        o: ["Modus Ponens.", "Modus Tollens.", "Falácia da afirmação do consequente.", "Contradição."], 
        a: 1, 
        e: "Modus Tollens: Se P implica Q, e Q é falso, então P deve ser falso. (P -> Q; ~Q; logo ~P)." 
    },
    { 
        id: 2015, s: 'l', p: 1, 
        q: "A negação da frase 'Se o relógio do sistema está sincronizado, os quadros de vídeo não pulam' é:", 
        o: ["O relógio do sistema está sincronizado e os quadros de vídeo pulam.", "O relógio do sistema não está sincronizado ou os quadros de vídeo não pulam.", "Se os quadros de vídeo pulam, então o relógio não está sincronizado.", "O relógio do sistema não está sincronizado e os quadros de vídeo não pulam."], 
        a: 0, 
        e: "Regra do MANÉ (Mantém a 1ª E Nega a 2ª): A negação de 'os quadros não pulam' é 'os quadros pulam'." 
    },
    { 
        id: 2016, s: 'l', p: 1, 
        q: "Considerando três proposições simples (P, Q, R), quantas linhas terá a tabela-verdade da proposição composta (P ^ Q) -> R?", 
        o: ["4 linhas.", "6 linhas.", "8 linhas.", "16 linhas."], 
        a: 2, 
        e: "Fórmula de linhas da tabela-verdade: 2^n, onde n é o número de proposições simples. 2³ = 8." 
    },
    { 
        id: 2017, s: 'l', p: 1, 
        q: "Uma proposição equivalente a 'O técnico revisa o cabeamento ou a transmissão falha' é:", 
        o: ["Se o técnico revisa o cabeamento, então a transmissão não falha.", "Se o técnico não revisa o cabeamento, então a transmissão falha.", "Se a transmissão falha, então o técnico revisou o cabeamento.", "O técnico revisa o cabeamento e a transmissão não falha."], 
        a: 1, 
        e: "Equivalência de (P v Q) para condicional: (~P -> Q). Nega-se a primeira parte e transforma o OU em SE...ENTÃO." 
    },
    { 
        id: 2018, s: 'l', p: 1, 
        q: "A afirmação 'Nenhum equipamento de áudio é digital' é FALSA. Disso pode-se concluir que:", 
        o: ["Todos os equipamentos de áudio são digitais.", "Pelo menos um equipamento de áudio é digital.", "Alguns equipamentos de áudio não são digitais.", "Nenhum equipamento digital é de áudio."], 
        a: 1, 
        e: "Se a negação (Nenhum) é falsa, a sua contraparte (Algum/Pelo menos um) deve ser verdadeira." 
    },
    { 
        id: 2019, s: 'l', p: 1, 
        q: "A proposição composta 'P ^ ~P' (P e não P) é classificada como:", 
        o: ["Tautologia.", "Contingência.", "Contradição.", "Equivalência."], 
        a: 2, 
        e: "Contradição é uma proposição que é sempre falsa, independentemente do valor de P. Algo não pode ser e não ser ao mesmo tempo." 
    },
    { 
        id: 2020, s: 'l', p: 1, 
        q: "Qual o conectivo lógico que apresenta valor verdadeiro apenas quando o número de proposições verdadeiras é ímpar (no caso de duas proposições, quando os valores são diferentes)?", 
        o: ["Disjunção Inclusiva.", "Bicondicional.", "Disjunção Exclusiva.", "Conjunção."], 
        a: 2, 
        e: "A Disjunção Exclusiva (XOR) exige que os valores sejam diferentes para resultar em verdade." 
    },
    ...
    { id: 119, s: 'g', p: 2, q: "Sobre a Lei Orgânica de Goiânia, em caso de impedimento simultâneo do Prefeito e do Vice-Prefeito, quem deverá assumir o cargo interinamente?", o: ["O Secretário de Governo.", "O Presidente da Câmara Municipal.", "O Juiz Diretor do Foro da Comarca de Goiânia.", "O Vereador com o maior número de votos na última eleição."], a: 1, e: "A linha de sucessão municipal prevê que o Presidente da Câmara assume a prefeitura na ausência do Prefeito e do Vice." },
    { id: 123, s: 'g', p: 2, q: "O 'Plano Diretor de Goiânia', elaborado na década de 30 por Attilio Corrêa Lima, previa uma cidade para quantos habitantes?", o: ["15 mil", "50 mil", "100 mil", "500 mil"], a: 1, e: "O projeto original de Attilio previa uma capital para 50.000 habitantes." },
    ...
    {
        id: 2021, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2022, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2023, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2024, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2025, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2026, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2027, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2028, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2029, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 2030, s: 'g', p: 2, tema: "História e Geografica GO",
    ...
    {
        id: 3012, s: 'g', p: 2, tema: "Administração Pública",
    ...
    {
        id: 3013, s: 'g', p: 2, tema: "Legislação Camara Municipal",
 ...
 // =================================================================================
    ...
    // =================================================================================
    {
        id: 3018, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3019, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3020, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3021, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3022, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3023,  s: 'g', p: 2, tema: "ALEGO - Legislação",
        ...
        a: 0,
        e: "<b>Análise:</b> 1ª Falsa: Câmara representa o POVO (Senado representa Estados). 2ª Verdadeira: É a literalidade do Art. 45, §1º da CF. 3ª Falsa: Renovação parcial (1/3 e 2/3) é regra do SENADO."
    },

    {
        id: 3024, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3025, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3026, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 3052, s: 'g', p: 2, tema: "ALEGO - Legislação",
        q: "Sobre o Senado Federal, é correto afirmar que cada Estado e o Distrito Federal elegerão:",
        o: ["Dois Senadores, com mandato de 8 anos.", "Três Senadores, com mandato de 4 anos.", "Três Senadores, com mandato de 8 anos.", "Dois Senadores, com mandato de 4 anos."],
        a: 2,
        e: "Art. 46, CF: Cada Estado e o DF elegerão três Senadores, com mandato de oito anos."
    },
    {
        id: 3053, s: 'g', p: 3, tema: "Lei de licitações 14.133",
        q: "Qual modalidade de licitação foi CRIADA pela Lei nº 14.133/2021?",
        o: ["Pregão", "RDC", "Tomada de Preços", "Diálogo Competitivo"],
        a: 3,
        e: "O Diálogo Competitivo é a nova modalidade introduzida pela NLLC para soluções complexas (Art. 32)."
    },
    {
        id: 3054, s: 'g', p: 2, tema: "ALEGO - Legislação",
        q: "A idade mínima para ser eleito Deputado Federal e Senador é, respectivamente:",
        o: ["21 e 35 anos", "18 e 30 anos", "21 e 30 anos", "35 e 35 anos"],
        a: 0,
        e: "Art. 14, §3º, VI: 21 anos para Deputado e 35 anos para Senador."
    },
    {
        id: 3055, s: 'g', p: 2, tema: "Lei de licitações 14.133",
        q: "Na Nova Lei de Licitações (14.133/21), a fase de habilitação ocorre, como regra:",
        o: ["Antes do julgamento das propostas.", "Após o julgamento das propostas.", "Simultaneamente à divulgação do edital.", "Apenas se houver recurso."],
        a: 1,
        e: "A NLLC inverteu as fases (Art. 17): primeiro julga-se a proposta, depois habilita-se o vencedor."
    },
    {
        id: 3056, s: 'g', p: 2, tema: "ALEGO - Legislação",
        q: "Cada legislatura terá a duração de:",
        o: ["1 ano", "2 anos", "4 anos", "8 anos"],
        a: 2,
        e: "Art. 44, Parágrafo único: Cada legislatura terá a duração de quatro anos."
    },
    {
        id: 3057, s: 'g', p: 3, tema: "Lei de licitações 14.133",
        q: "O critério de julgamento 'maior retorno econômico' é utilizado prioritariamente em:",
        o: ["Obras de grande vulto", "Contratos de eficiência", "Leilões de imóveis", "Aquisição de bens comuns"],
        a: 1,
        e: "Art. 39 da Lei 14.133: O maior retorno econômico é usado em contratos de eficiência (focado na economia gerada)."
    },
    {
        id: 3058, s: 'g', p: 2, tema: "ALEGO - Legislação",
        q: "Compete privativamente à Câmara dos Deputados:",
        o: ["Aprovar escolha de magistrados.", "Processar e julgar o Presidente por crimes de responsabilidade.", "Autorizar a instauração de processo contra o Presidente e o Vice.", "Zelar pela preservação da competência legislativa."],
        a: 2,
        e: "Art. 51, I: Compete à Câmara autorizar (por 2/3) o processo. O julgamento cabe ao Senado."
    },
    {
        id: 3059, s: 'g', p: 2, tema: "Lei de licitações 14.133",
        q: "Quais modalidades da Lei 8.666/93 foram extintas pela Lei 14.133/21?",
        o: ["Convite e Tomada de Preços", "Concorrência e Leilão", "Pregão e Concurso", "Apenas o Convite"],
        a: 0,
        e: "A Nova Lei de Licitações não previu mais as modalidades Convite e Tomada de Preços."
    },
    {
        id: 3060, s: 'g', p: 1, tema: "Lei de licitações 14.133",
        q: "Qual o nome do portal oficial que centraliza a divulgação das contratações públicas no Brasil?",
        o: ["Portal da Transparência", "ComprasNet", "PNCP (Portal Nacional de Contratações Públicas)", "Diário Oficial da União"],
        a: 2,
        e: "Art. 174: O PNCP é o sítio eletrônico oficial centralizador de dados e editais."
    },
    {
        id: 3061, s: 'g', p: 2, tema: "ALEGO - Legislação",
        q: "O Senado Federal é renovado de 4 em 4 anos por:",
        o: ["Metade e metade", "Sempre integralmente", "Um e dois terços, alternadamente", "Apenas um terço"],
        a: 2,
        e: "Art. 46, §2º da CF: Renovação parcial alternada por um e dois terços."
    },

     {
        id: 502, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 503, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 504, s: 'g', p: 2, tema: "ALEGO - Legislação",
    ...
    {
        id: 505, s: 'g', p: 2, tema: "ALEGO - Legislação",
 ...
 // =================================================================================
    // DEVERES E ETICA NA CAMARA MUNICIPAL
    // =================================================================================


    {
        id: 3073, s: 'g', p: 1,
        q: "O dever do servidor da Câmara Municipal de manter uma conduta cortês e respeitosa no trato com colegas e com o público em geral refere-se à:",
        o: ["Assiduidade", "Urbanidade", "Discrição", "Lealdade"],
        a: 1,
        e: "<b>Urbanidade:</b> É o dever de polidez, cortesia e civilidade no trato diário no serviço público."
    },
    {
        id: 3074, s: 'g', p: 2,
        q: "O servidor que se ausenta habitualmente do serviço na Câmara Municipal, sem causa justificada, descumpre o dever fundamental de:",
        o: ["Produtividade", "Prostração", "Assiduidade", "Hierarquia"],
        a: 2,
        e: "<b>Assiduidade:</b> Refere-se à regularidade do comparecimento ao trabalho. A falta habitual pode configurar abandono de cargo."
    },
    {
        id: 3075, s: 'g', p: 1,
        q: "Guardar sigilo sobre assuntos da Câmara Municipal que o servidor tenha conhecimento em razão do cargo é uma manifestação do dever de:",
        o: ["Paciência", "Publicidade", "Discrição", "Imparcialidade"],
        a: 2,
        e: "<b>Discrição:</b> O servidor deve ser reservado quanto a informações internas e sigilosas das quais toma conhecimento no exercício da função."
    },
    {
        id: 3076, s: 'g', p: 2,
        q: "Cumprir rigorosamente o horário de trabalho estabelecido pela Mesa Diretora da Câmara Municipal é o cumprimento do dever de:",
        o: ["Pontualidade", "Eficiência", "Subordinação", "Zelo"],
        a: 0,
        e: "<b>Pontualidade:</b> Estar presente no posto de trabalho nos horários de início, intervalo e término definidos."
    },
    {
        id: 3077, s: 'g', p: 2,
        q: "A reiteração no descumprimento dos deveres de assiduidade e pontualidade geralmente sujeita o servidor municipal à penalidade de:",
        o: ["Demissão direta", "Multa pecuniária", "Advertência ou Suspensão", "Censura pública"],
        a: 2,
        e: "Em regra, infrações leves de deveres funcionais resultam em advertência; em caso de reincidência, suspensão."
    },
    {
        id: 3078, s: 'g', p: 2,
        q: "No ambiente da Câmara Municipal, o servidor deve 'tratar com presteza o público'. Isso significa:",
        o: ["Dar prioridade apenas aos Vereadores.", "Atender com rapidez e eficiência todos os cidadãos.", "Ignorar solicitações por telefone.", "Atender apenas em dias de sessão plenária."],
        a: 1,
        e: "<b>Presteza:</b> Atendimento ágil e prestativo, essencial para a eficácia do serviço público municipal."
    },
    {
        id: 3079, s: 'g', p: 3,
        q: "Levar documentos ou objetos da Câmara Municipal para casa sem autorização prévia da chefia é uma violação ao dever de:",
        o: ["Urbanidade", "Zelo pelo patrimônio e lealdade às instituições", "Discrição", "Independência"],
        a: 1,
        e: "O servidor deve zelar pelos bens públicos e só pode retirar documentos ou objetos da repartição se devidamente autorizado."
    },
    {
        id: 3080, s: 'g', p: 2,
        q: "Cumprir as ordens superiores, exceto quando manifestamente ilegais, é um dever fundamentado na:",
        o: ["Assiduidade", "Hierarquia e Obediência", "Pontualidade", "Segregação de funções"],
        a: 1,
        e: "O dever de obediência é pilar da administração pública, salvo se a ordem for claramente criminosa ou ilegal."
    },
    {
        id: 3081, s: 'g', p: 3,
        q: "É proibido ao servidor da Câmara Municipal valer-se do cargo para lograr proveito pessoal ou de outrem. Isso fere o princípio da:",
        o: ["Imparcialidade e Moralidade", "Publicidade", "Eficiência", "Hierarquia"],
        a: 0,
        e: "Usar o cargo para benefício próprio viola a Moralidade Administrativa e o dever de Imparcialidade."
    },
    {
        id: 3082, s: 'g', p: 2,
        q: "Representar contra ilegalidade, omissão ou abuso de poder que venha a tomar conhecimento na Câmara Municipal é um(a):",
        o: ["Dever do servidor.", "Faculdade que o servidor usa se quiser.", "Proibição expressa.", "Atribuição exclusiva dos Vereadores."],
        a: 0,
        e: "É dever do servidor público levar ao conhecimento da autoridade superior as irregularidades de que tiver ciência em razão do cargo."
    },
...
// BLOCO: GEO-HISTÓRIA E LEGISLAÇÃO AVANÇADA (NÍVEL CÂMARA DE GOIÂNIA)
    ...
    { 
        ...
        a: 2, 
        e: "A 'Marcha para o Oeste' foi o slogan e política de Getúlio Vargas para colonizar e desenvolver o interior do Brasil." 
    },
    ...
    {
        id: 263, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 264, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 265, s: 'e', p: 3, tema: "Operação de caracteres",
    ...
    {
        id: 266, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 116, s: 'e', p: 3, tema: "Sinal e formato",
        q: "Um sinal de vídeo 1080p a 59.94Hz transportado via 3G-SDI Level A difere do Level B principalmente por:",
    ...
    {
        id: 401, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 6001, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 6002, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 2031, s: 'e', p: 3, tema: "Operação de caracteres",
    ...
    {
        id: 2032, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 2033, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 2034, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 2035, s: 'e', p: 3, tema: "Operação de caracteres",
    ...
    {
        id: 2036, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 2037, s: 'e', p: 3, tema: "Operação de caracteres",
    ...
    {
        id: 2038, s: 'e', p: 3, tema: "Operação de caracteres",
        q: "Template é um:",
    ...
    {
        id: 2039, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 2040, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 3031, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 3032, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 3035, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 3038, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 3040, s: 'e', p: 3, tema: "Operação de Audio",
    ...
    {
        id: 260, s: 'e', p: 3, tema: "Sinal e formato",
    ...
    {
        id: 261, s: 'e', p: 3, tema: "Sinal e formato",
...
// BLOCO: CONHECIMENTOS ESPECÍFICOS AVANÇADOS (VÍDEO, ÁUDIO E BROADCAST IP)

    { 
        id: 4001, s: 'e', p: 3, 
        q: "No contexto de infraestruturas de vídeo sobre IP, qual a diferença fundamental entre os protocolos NDI High Bandwidth (Full NDI) e NDI|HX?", 
        o: ["O NDI Full utiliza compressão Long-GOP (H.264), enquanto o NDI|HX é sem perdas (Lossless).", "O NDI Full utiliza compressão Intraframe de baixa latência e alta taxa de bits, enquanto o NDI|HX utiliza alta compressão (H.264/H.265) para economizar banda de rede.", "O NDI|HX não suporta sinais em 1080p, sendo limitado à resolução SD.", "O NDI Full exige cabos coaxiais BNC, enquanto o NDI|HX roda exclusivamente em Wi-Fi."], 
        a: 1, 
        e: "O NDI Full prioriza a qualidade e latência quase zero (usando mais banda), enquanto o HX (High Efficiency) é focado em redes limitadas usando codecs de alta compressão." 
    },
    { 
        id: 4002, s: 'e', p: 3, 
        q: "Ao configurar um Switcher de vídeo, a função 'DSK' (Downstream Keyer) é tecnicamente posicionada no fluxo de sinal:", 
        o: ["Antes das transições de corte (M/E), para permitir que o gráfico acompanhe a troca de câmeras.", "Imediatamente após o ganho da lente da câmera, para processar o ISO individualmente.", "Na última etapa do processamento de vídeo, após o barramento de efeitos e transições, garantindo que o gráfico fique sobreposto a qualquer outra fonte.", "Exclusivamente nas saídas de auxiliares para monitoramento dos vereadores."], 
        a: 2, 
        e: "Downstream significa 'rio abaixo'. É a última camada de inserção de caracteres antes da saída final do sinal (PGM)." 
    },
    { 
        id: 4003, s: 'e', p: 3, 
        q: "O sinal de áudio balanceado (XLR) utiliza três condutores (Pino 1: Terra; Pino 2: Quente; Pino 3: Frio). O cancelamento de ruídos externos em cabos longos ocorre devido ao processo de:", 
        o: ["Amplificação de fase positiva no pino 2.", "Rejeição em Modo Comum (CMRR), onde o receptor inverte a fase do pino 3 e soma ao pino 2, cancelando ruídos captados igualmente em ambos.", "Transformação do sinal analógico em digital dentro do conector.", "Bloqueio de frequências acima de 20kHz através do pino de terra."], 
        a: 1, 
        e: "A inversão de fase na entrada da mesa faz com que o ruído (que entrou igual nos dois fios) seja anulado por interferência destrutiva, mantendo apenas o sinal original." 
    },
    { 
        id: 4004, s: 'e', p: 3, 
        q: "Em transmissões SDI, o fenômeno de 'Jitter' é uma instabilidade temporal que pode degradar o sinal. Para mitigar esse problema em cabos coaxiais muito longos, utiliza-se um equipamento chamado:", 
        o: ["Distribuidor de Vídeo (DA).", "Reclocker (ou Regenerador de sinal).", "Conversor de Aspect Ratio.", "Filtro de Linha."], 
        a: 1, 
        e: "O reclocker analisa o sinal digital recebido, extrai o relógio (clock) original e reconstrói os pulsos digitais, eliminando as variações de tempo (jitter)." 
    },
    { 
        id: 4005, s: 'e', p: 3, 
        q: "O padrão de compressão de cor 4:2:2, comum no ambiente broadcast, significa que:", 
        o: ["A resolução da cor é exatamente igual à resolução da luminância.", "A luminância (Y) é amostrada integralmente, enquanto os componentes de cor (Cb e Cr) têm metade da resolução horizontal.", "O sinal de vídeo possui 4 canais de cor e 2 de transparência.", "A taxa de quadros é de 42,2 frames por segundo."], 
        a: 1, 
        e: "Subamostragem de croma: 4 (luminância total) : 2 (metade da cor horizontal) : 2 (metade da cor vertical ou horizontal dependendo do padrão). É o equilíbrio ideal entre peso de arquivo e fidelidade visual." 
    },
    { 
        id: 4006, s: 'e', p: 3, 
        q: "O protocolo SRT (Secure Reliable Transport) utiliza uma técnica para garantir a entrega de pacotes de vídeo em redes de internet instáveis chamada:", 
        o: ["Multicast de alta densidade.", "ARQ (Automatic Repeat Request), que solicita a retransmissão de pacotes perdidos baseada em um buffer de latência configurável.", "Compressão Intraframe pura.", "Sincronismo via satélite GPS."], 
        a: 1, 
        e: "O SRT é superior ao RTMP justamente por gerenciar perdas de pacotes através de retransmissões inteligentes controladas por um buffer de tempo." 
    },
    { 
        id: 4007, s: 'e', p: 3, 
        q: "No Gerador de Caracteres, o que diferencia tecnicamente uma fonte 'Serifada' de uma 'Sem Serifa' (Sans Serif)?", 
        o: ["O tamanho da letra em pontos (DPI).", "A presença de pequenos prolongamentos ou traços nas extremidades das letras.", "A capacidade da fonte de suportar o canal Alpha.", "O espaçamento horizontal entre as palavras (Kerning)."], 
        a: 1, 
        e: "Serifas são os 'pezinhos' das letras (ex: Times New Roman). Sans Serif são letras limpas (ex: Arial), preferidas em TV por evitarem o efeito de cintilação (flicker)." 
    },
    { 
        id: 4008, s: 'e', p: 3, 
        q: "O recurso 'Genlock' (Generator Locking) em um estúdio com múltiplas câmeras serve para:", 
        o: ["Travar o foco das lentes para que não oscilem durante a transmissão.", "Sincronizar a varredura vertical e horizontal de todas as fontes de vídeo ao mesmo relógio mestre.", "Impedir que usuários não autorizados acessem o switcher.", "Aumentar a resolução de câmeras 720p para 1080p."], 
        a: 1, 
        e: "Sem Genlock, os quadros de vídeo das câmeras 'chegam' em tempos diferentes no switcher, causando saltos pretos ou glitches no momento do corte." 
    },
    { 
        id: 4009, s: 'e', p: 3, 
        q: "Qual a função do 'Alpha Channel' (Canal Alpha) em arquivos de vídeo ou imagem exportados para o GC?", 
        o: ["Definir a cor primária do texto.", "Controlar o nível de brilho (luminância) da imagem.", "Armazenar informações de transparência, permitindo que o vídeo de fundo apareça através das áreas vazadas do gráfico.", "Codificar o áudio embutido no arquivo gráfico."], 
        a: 2, 
        e: "O Canal Alpha é o quarto canal (além de R, G, B) que define o que é opaco e o que é transparente no gráfico." 
    },
    { 
        id: 4010, s: 'e', p: 3, 
        q: "Ao operar uma mesa de som digital, o efeito de 'Sidechain' em um compressor é frequentemente usado para:", 
        o: ["Aumentar o eco da voz do apresentador.", "Reduzir automaticamente o volume da trilha sonora sempre que o locutor fala (Ducking).", "Transformar um sinal mono em estéreo falso.", "Limpar ruídos de baixa frequência abaixo de 100Hz."], 
        a: 1, 
        e: "O Sidechain permite que a entrada de um canal (voz) controle a compressão de outro (trilha), criando o efeito profissional de locução sobre música." 
    },
    { 
        id: 4011, s: 'e', p: 3, 
        q: "Em uma rede Dante (Audio over IP), o que acontece se o 'Clock Master' da rede for desconectado?", 
        o: ["O áudio continua funcionando normalmente sem interrupções.", "A rede elege automaticamente um novo 'Clock Master' entre os dispositivos restantes para manter o sincronismo.", "Todo o sinal de áudio é convertido imediatamente para analógico.", "A rede trava e o áudio é interrompido em todos os canais."], 
        a: 1, 
        e: "Protocolos como Dante e AES67 utilizam eleição automática para garantir redundância de sincronismo (PTP)." 
    },
    { 
        id: 4012, s: 'e', p: 3, 
        q: "A resolução '4K UHD' comercial (3840x2160) possui quantas vezes mais pixels que a resolução Full HD (1920x1080)?", 
        o: ["2 vezes.", "3 vezes.", "4 vezes.", "8 vezes."], 
        a: 2, 
        e: "O 4K dobra a resolução na largura e na altura ($2 \times 2 = 4$). Cabem quatro telas Full HD dentro de uma tela 4K." 
    },
    { 
        id: 4013, s: 'e', p: 3, 
        q: "O conector BNC de 75 ohms é o padrão para sinais SDI. O uso de um conector BNC de 50 ohms (comum em rádio amador) em um sistema de vídeo digital causará:", 
        o: ["Aumento da qualidade do sinal.", "Casamento perfeito de impedância.", "Reflexões de sinal e aumento do erro de bits (BER), podendo causar perda de imagem.", "Explosão do conector por superaquecimento."], 
        a: 2, 
        e: "A descasamento de impedância faz com que parte da energia do sinal 'volte' pelo cabo, gerando interferência no próprio fluxo digital." 
    },
    { 
        id: 4014, s: 'e', p: 3, 
        q: "No software de Gerador de Caracteres, o ajuste de 'Kerning' refere-se ao:", 
        o: ["Espaço entre as linhas de um parágrafo.", "Espaçamento individual entre pares de letras para otimizar a legibilidade.", "Contorno aplicado ao redor das letras.", "Efeito de inclinação da fonte (Itálico)."], 
        a: 1, 
        e: "Kerning ajusta o espaço entre caracteres específicos (como 'A' e 'V') para evitar buracos visuais no texto." 
    },
    { 
        id: 4015, s: 'e', p: 3, 
        q: "O sinal de vídeo 'entrelaçado' (ex: 1080i) desenha a imagem na tela através de:", 
        o: ["Linhas horizontais em sequência única (1, 2, 3...).", "Dois campos de linhas que se alternam (um de linhas ímpares e outro de linhas pares).", "Pontos aleatórios que preenchem o sensor.", "Uma única varredura vertical da esquerda para a direita."], 
        a: 1, 
        e: "O sinal entrelaçado divide o quadro em dois campos para economizar banda, técnica herdada da TV analógica." 
    },
    { 
        id: 4016, s: 'e', p: 3, 
        q: "Um arquivo de vídeo com codec ProRes 4444 é preferível para uso em GCs de alta performance porque:", 
        o: ["É o formato mais leve que existe para internet.", "Suporta nativamente o Canal Alpha (transparência) com baixíssima perda de qualidade.", "Transforma vídeos 30fps em 60fps automaticamente.", "Pode ser lido por qualquer player doméstico de baixo custo."], 
        a: 1, 
        e: "O ProRes 4444 é um codec 'mezzanine' profissional que permite transportar o vídeo e a transparência em um único arquivo de alta fidelidade." 
    },
    { 
        id: 4017, s: 'e', p: 3, 
        q: "O que é o 'Luma Key' e em que situação ele é mais eficiente que o Chroma Key?", 
        o: ["Recorte por cor verde; eficiente em estúdios pequenos.", "Recorte por níveis de brilho; eficiente para sobrepor textos brancos ou logos com fundo preto puro.", "Recorte por profundidade de campo; eficiente para desfoque de fundo.", "Recorte por áudio; eficiente em sessões solenes."], 
        a: 1, 
        e: "O Luma Key ignora a cor e foca na luz. Se você tem um texto branco em fundo preto, o Luma Key apaga o preto perfeitamente sem precisar de fundo verde." 
    },
    { 
        id: 4018, s: 'e', p: 3, 
        q: "Em sistemas de áudio digital, o fenômeno de 'Aliasing' ocorre quando:", 
        o: ["O volume do microfone está muito baixo.", "A frequência do som captado é superior à metade da taxa de amostragem (Frequência de Nyquist).", "O cabo XLR está invertido.", "O som é gravado em formato MP3 de baixa qualidade."], 
        a: 1, 
        e: "Sem um filtro anti-aliasing, frequências altas 'rebatem' para dentro do espectro audível como ruídos matemáticos distorcidos." 
    },
    { 
        id: 4019, s: 'e', p: 3, 
        q: "Qual a função de um 'Frame Synchronizer' em uma entrada de switcher que recebe um sinal externo via mochila de link (como LiveU ou TVU)?", 
        o: ["Melhorar a cor da imagem externa.", "Armazenar o vídeo em um disco rígido para segurança.", "Alinhar o sinal instável e sem genlock da internet ao relógio interno do estúdio para permitir cortes limpos.", "Traduzir o idioma do repórter automaticamente."], 
        a: 2, 
        e: "Sinais vindos da internet não têm sincronismo de fase com o estúdio. O sincronizador de quadro 'segura' o sinal e o solta no tempo exato do switcher." 
    },
    { 
        id: 4020, s: 'e', p: 3, 
        q: "O termo 'Bitrate' em uma transmissão de streaming da TV Câmara define:", 
        o: ["A resolução da tela em pixels.", "A quantidade de dados transmitidos por segundo, impactando diretamente na qualidade visual e no consumo de internet.", "O número de câmeras conectadas ao switcher.", "O tempo total de duração da sessão plenária."], 
        a: 1, 
        e: "Bitrate é o fluxo de dados. Quanto maior o bitrate, menor a compressão e melhor a imagem (desde que a internet suporte)." 
    }
